...
import { generateTradingPlanAction } from './actions';
import { GenerateTradingPlanOutput } from '@/ai/flows/generate-trading-plan';
import { Loader2, BotMessageSquare, Sparkles, Shield, Target, BrainCircuit } from 'lucide-react';
...
export default function TradingPlanPage() {
  ...
  const onSubmit = async (data: TradingPlanFormData) => {
    ...
    setPlan(null);
    try {
      const result = await generateTradingPlanAction(data);
      setPlan(result);
